...
const LayoutPreview: React.FC<LayoutPreviewProps> = ({ textBlocks, pageWidth = 800, pageHeight = 1120, fitToParent = true }) => {
  ...
  function toRect(b: BBox) {
    if ("l" in b) {
      return { l: b.l, t: b.t, r: b.r, b: b.b, w: (b as any).width ?? Math.max(1, b.r - b.l), h: (b as any).height ?? Math.max(1, b.b - b.t) };
    }
  ...
  const rects = textBlocks.map(tb => toRect(tb.bbox as any));
